...
public class AluminumBoatRenderer extends AbstractBoatRenderer<AluminumBoatEntity>
{
    ...
    public RayTraceTransforms getRayTraceTransforms()
    {
        return (entityRayTracer, transforms, parts) ->
        {
            ...
            TransformHelper.createFuelFillerTransforms(ModEntities.ALUMINUM_BOAT.get(), com.mrcrayfish.vehicle.client.model.SpecialModels.FUEL_DOOR_CLOSED, parts, transforms);
        };
    }
}
