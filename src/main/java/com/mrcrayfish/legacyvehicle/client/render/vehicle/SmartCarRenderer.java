...
public class SmartCarRenderer extends AbstractLandVehicleRenderer<SmartCarEntity>
{
    ...
    public RayTraceTransforms getRayTraceTransforms()
    {
        return (tracer, transforms, parts) ->
        {
            ...
            TransformHelper.createFuelFillerTransforms(ModEntities.SMART_CAR.get(), com.mrcrayfish.vehicle.client.model.SpecialModels.FUEL_DOOR_CLOSED, parts, transforms);
        };
    }
}
